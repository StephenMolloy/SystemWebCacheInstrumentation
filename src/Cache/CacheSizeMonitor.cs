//------------------------------------------------------------------------------
// CacheSizeMonitor.cs - based on CacheSizeMonitor from .Net Framework
//
...
namespace CacheInstrumentation.CacheProvider
{
    ...
    sealed class CacheSizeMonitor {
        ...
        internal void ReadConfig(CacheSection cacheSection) {
            ...
            _memoryLimit = ReflectionUtils.GetConfiguredProcessMemoryLimit();
            ...
            if (privateBytesLimit == 0 && _memoryLimit == 0) {
                ...
                _memoryLimit = ReflectionUtils.GetProcessPrivateBytesLimit();
            }
